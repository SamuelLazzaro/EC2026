...
/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
const sectionIds = ['home', 'luogo', 'parcheggi', 'impianto', 'sponsor', 'comunicazioni', /* 'biglietti', */ 'programma', 'foto', /* 'diretta', */ 'maratona', /* 'classifiche', */ 'alloggi', 'ristorazione', 'contatti'];
